    ...
    <div className="space-y-6">
      ...
      {current?.running && (
        <Card className="border-sky-500/30 bg-sky-500/5">
          <CardContent className="p-4">
            ...
            <div className="bg-zinc-900 rounded p-3 font-mono text-xs text-zinc-500 max-h-40 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <h2 className="text-lg font-semibold text-zinc-300">Agent Log</h2>
          {log.map((entry, i) => (
