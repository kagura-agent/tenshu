...
const THEME_STYLES = {
  warroom: {
    background:
      'linear-gradient(135deg, #1a1410 0%, #1e1a10 50%, #1a1410 100%)',
    borderColor: 'rgba(180, 140, 80, 0.08)',
  },
  deck: {
    background:
      'linear-gradient(135deg, #08081a 0%, #0c0c2e 50%, #08081a 100%)',
    borderColor: 'rgba(6, 182, 212, 0.08)',
  },
  garden: {
    background:
      'linear-gradient(135deg, #1a1018 0%, #1e1420 50%, #1a1018 100%)',
...
export function ThemedMain({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      {!isCommand && <AnimatedCanvas theme={theme} intensity={0.15} />}
