...
const CARD_STYLES: Record<ThemeMode, { bg: string; border: string; hoverBorder: string }> = {
  warroom: {
...
export function ThemedCard({ children, className = "", style, glow, onClick }: ThemedCardProps) {
