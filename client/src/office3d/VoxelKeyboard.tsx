  ...
  return (
    <group position={position} rotation={rotation}>
      ...
      {Array.from({ length: 10 }).map((_, i) => (
        <Box key={`top-${i}`} args={[0.06, 0.03, 0.06]} position={[-0.32 + i * 0.072, 0.035, -0.08]} castShadow>
      ...
      {Array.from({ length: 9 }).map((_, i) => (
        <Box key={`mid-${i}`} args={[0.06, 0.03, 0.06]} position={[-0.28 + i * 0.072, 0.035, -0.01]} castShadow>
          <meshStandardMaterial color="#1f2937" />
        </Box>
      ))}
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        <Box key={`low-${i}`} args={[0.06, 0.03, 0.06]} position={[-0.24 + i * 0.072, 0.035, 0.06]} castShadow>
          <meshStandardMaterial color="#1f2937" />
        </Box>
      ))}
