  ...
  return (
    <div className="mt-1.5 space-y-0.5">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[7px] text-pink-300/40">
      ...
      {entries.slice(0, 2).map((e) => (
        <div key={e.cycle} className="flex items-center gap-1.5 text-[8px]">
          ...
          <span
            className="text-pink-200/50 truncate flex-1"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, transparent 40%, rgba(26, 16, 24, 0.6) 100%)',
        }}
      />
      ...
      {current?.running && (
        <div
          className="relative z-20 mx-auto mt-1 flex items-center gap-3 px-4 py-1.5 rounded-lg border border-pink-300/20"
          style={{
        ...
        >
          ...
          {current.lastStatus && (
            <span className="text-[10px] text-pink-200/40">
              {current.lastStatus}
            </span>
          )}
        </div>
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div
                      className="mt-0.5 px-2 py-0.5 rounded-full text-[9px] font-bold inline-block border"
                      style={{
                        color: statusColor,
      ...
      {current?.recentLines && current.recentLines.length > 0 && (
        <div className="relative z-10 px-6 pb-3">
          <div
            className="w-[28rem] font-mono text-[10px] leading-relaxed rounded-lg border border-pink-300/10 p-3 overflow-hidden"
            style={{
      ...
      <svg
        className="absolute bottom-3 right-6 opacity-[0.06] z-5"
        width="120"
        height="60"
        viewBox="0 0 120 60"
      >
        ...
        />
        <path
          d="M0 30 Q15 20 30 30 Q45 40 60 30 Q75 20 90 30 Q105 40 120 30"
          fill="none"
          stroke="#f472b6"
          strokeWidth="1.5"
        />
        <path
          d="M0 45 Q15 35 30 45 Q45 55 60 45 Q75 35 90 45 Q105 55 120 45"
          fill="none"
          stroke="#f472b6"
          strokeWidth="1.5"
        />
